...
class ActorTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'pelis.Map.ActorTableMap';
     ...
     */
    const OM_CLASS = '\\pelis\\Actor';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'pelis.Actor';
     ...
     */
    const COL_ID = 'actor.id';

    /**
     * the column name for the nombre field
     */
    const COL_NOMBRE = 'actor.nombre';

    /**
     * the column name for the apellido field
     */
    const COL_APELLIDO = 'actor.apellido';

    /**
     * the column name for the edad field
     */
    const COL_EDAD = 'actor.edad';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Nombre', 'Apellido', 'Edad', ),
        self::TYPE_CAMELNAME     => array('id', 'nombre', 'apellido', 'edad', ),
        self::TYPE_COLNAME       => array(ActorTableMap::COL_ID, ActorTableMap::COL_NOMBRE, ActorTableMap::COL_APELLIDO, ActorTableMap::COL_EDAD, ),
        self::TYPE_FIELDNAME     => array('id', 'nombre', 'apellido', 'edad', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Nombre' => 1, 'Apellido' => 2, 'Edad' => 3, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'nombre' => 1, 'apellido' => 2, 'edad' => 3, ),
        self::TYPE_COLNAME       => array(ActorTableMap::COL_ID => 0, ActorTableMap::COL_NOMBRE => 1, ActorTableMap::COL_APELLIDO => 2, ActorTableMap::COL_EDAD => 3, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'nombre' => 1, 'apellido' => 2, 'edad' => 3, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\pelis\\Actor');
        $this->setPackage('pelis');
        $this->setUseIdGenerator(true);
        // columns
        $this->addPrimaryKey('id', 'Id', 'INTEGER', true, null, null);
        $this->addColumn('nombre', 'Nombre', 'VARCHAR', true, 200, null);
        $this->addColumn('apellido', 'Apellido', 'VARCHAR', true, 200, null);
        $this->addColumn('edad', 'Edad', 'INTEGER', true, null, null);
    } // initialize()
  ...
  array (
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(ActorTableMap::COL_ID);
            $criteria->addSelectColumn(ActorTableMap::COL_NOMBRE);
            $criteria->addSelectColumn(ActorTableMap::COL_APELLIDO);
            $criteria->addSelectColumn(ActorTableMap::COL_EDAD);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \pelis\Actor) { // it's a model object
            // create criteria based on pk values
            $criteria = $values->buildPkeyCriteria();
        } else { // it's a primary key, or an array of pks
            $criteria = new Criteria(ActorTableMap::DATABASE_NAME);
            $criteria->add(ActorTableMap::COL_ID, (array) $values, Criteria::IN);
        }
        ...
        if ($values instanceof Criteria) {
            ...
            foreach ((array) $values as $singleval) {
                ActorTableMap::removeInstanceFromPool($singleval);
            }
        }
    ...
    public static function doInsert($criteria, ConnectionInterface $con = null)
    {
        ...
        if ($criteria->containsKey(ActorTableMap::COL_ID) && $criteria->keyContainsValue(ActorTableMap::COL_ID) ) {
